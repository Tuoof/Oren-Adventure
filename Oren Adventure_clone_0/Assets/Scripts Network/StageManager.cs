...
namespace oren_Network
{
    ...
    public class StageManager : NetworkBehaviour
    {
        ...
        private Dictionary<ulong, bool> m_ClientsInStage;
        ...
        void Awake()
        {
            m_ClientsInStage = new Dictionary<ulong, bool>();
            m_TimeRemaining = 120.0f;
            if (IsHost || IsClient) m_ClientsInStage.Add(NetworkManager.Singleton.LocalClientId, true);
        ...
        private void UpdateAndCheckPlayersInStage()
        {
            ...
            if (m_ClientsInStage.Count <= 0)
            {
                ...
                Debug.LogFormat("we were notified the All player in Stage was {0}", m_ClientsInStage.Count);
            }
