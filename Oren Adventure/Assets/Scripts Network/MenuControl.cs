...
namespace oren_Network
{
    public class MenuControl : NetworkBehaviour
    {
        ...
        public void StartServerGame()
        {
            ...
            // if (transport) { m_HostIpInput.text = "127.0.0.1"; }
        ...
        public void StartLocalClientGame()
        {
            ...
            if (m_HostIpInput.text != "Hostname")
            {
                ...
                if (transport)
                {
                    // transport.SetConnectionData(m_HostIpInput.text, portAddress );
                    // transport.ConnectAddress = m_HostIpInput.text;
                    // transport.ConnectPort = portAddress;
                }
